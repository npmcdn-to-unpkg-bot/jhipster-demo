...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "project1@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "project1 API";

        private String description = "project1 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "project1";
